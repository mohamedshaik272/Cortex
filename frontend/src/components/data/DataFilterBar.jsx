...
const baseInput =
  'h-11 rounded-xl border border-orange-200/30 bg-elevated px-4 text-sm text-ink placeholder:text-muted/60 focus:border-accent/40 focus:outline-none focus:ring-2 focus:ring-accent/20 transition-colors';
...
export default function DataFilterBar() {
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-orange-200/30 bg-elevated px-4 py-3 ring-1 ring-orange-100/40 sm:px-6 sm:py-4">
