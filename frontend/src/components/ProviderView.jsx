      ...
      <div className="grid gap-6 lg:grid-cols-5">
        <div className="rounded-2xl border border-orange-200/30 bg-elevated p-6 ring-1 ring-orange-100/40 lg:col-span-2">
          ...
          <p className="mt-1 text-sm text-muted">
            Normalized 0\u20131 vs. trailing 12 months.
          </p>
            ...
            {regionSignals.map((r) => (
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span
                    className={`text-sm font-semibold ${trendClass(r.trend)}`}
                  >
                ...
                <p className="mt-2 text-xs text-muted">
                  Top category:{' '}
                  <span className="text-muted">{r.topCategory}</span>
                </p>
              </li>
            ))}
          </ul>
        ...
        <div className="rounded-2xl border border-orange-200/30 bg-elevated p-6 ring-1 ring-orange-100/40 lg:col-span-3">
          ...
          <p className="mt-1 text-sm text-muted">
            Where homeowner demand is concentrating next.
          </p>
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 max-w-xl text-sm text-muted">
              OEMs, distributors, and field service teams connect to the same
              data — planning from shared knowledge about how
              homes actually age and what they need.
            </p>
          </div>
